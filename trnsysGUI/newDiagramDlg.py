...
from PyQt5.QtWidgets import QDialog, QLineEdit, QLabel, QPushButton, QHBoxLayout, QGridLayout


class newDiagramDlg(QDialog):
    def __init__(self, parent):
        super(newDiagramDlg, self).__init__(parent)
        self.diag = parent
