...
def createExportConnection(
    hydraulicConnection: HydraulicDoublePipeConnection, lengthInM: float, shallBeSimulated: bool
) -> _hedpc.ExportDoublePipeConnection:
    exportHydraulicConnection = createExportHydraulicConnection(hydraulicConnection)
