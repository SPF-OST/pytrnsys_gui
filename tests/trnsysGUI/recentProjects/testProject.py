...
class TestProject:
    ...
    def testIsValidProjectEnviromentValid(self, monkeypatch):
        ...
        isValid = checkIfProjectEnviromentIsValid(PATH_TO_PROJECT_1.parent, PATH_TO_PROJECT_1)
    ...
    def testIsValidProjectEnviromentInvalid(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "trnsysGUI.project.getExistingEmptyDirectory", lambda startingDirectoryPath: PATH_TO_PROJECT_2
        )

        isValid = checkIfProjectEnviromentIsValid(PATH_TO_PROJECT_2.parent, PATH_TO_PROJECT_1)
