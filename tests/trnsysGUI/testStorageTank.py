...
import trnsysGUI.Connection as _con
...
class TestStorageTank:
    ...
    def testDeserializeJsonFromLegacyFormatAndSerialize(self, tmp_path):
    ...
    "trnsysId": 638
        ...
        storageTank = self._deserializeStorageTank(self.LEGACY_JSON, diagramViewMock)
    ...
    def testExportDdck(self, tmp_path):
        logger = _log.getLogger("root")
        (
            diagramViewMock,
            objectsNeededToBeKeptAliveWhileTanksAlive,
